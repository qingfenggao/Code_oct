...
%             roi.median(i) = median(roicidata(k_inside));
            ...
            roicidata     =  roicidata(k_inside);
            roidata = roicidata(:);
            roidata((roidata==0)) = [];
            roi.mean(i)   =   mean(roidata);
            roi.std(i)    =    std(roidata);
            roi.min(i)    =    min(roidata);
            roi.max(i)    =    max(roidata);
            roi.median(i) = median(roidata);
        ...
        disp(fprintf('%20s\t %10.3f', 'pix area = ', roi.apix) );  
        disp(sprintf('%20s\t %10.3f\t %10.3f\t', 'roicenter [x,y] = ', roi.center)); 
        disp(sprintf('%20s\t %10.3f\t %10.3f\t %10.3f', 'mean = ', roi.mean) );  
        disp(sprintf('%20s\t %10.3f\t %10.3f\t %10.3f', 'std = ',  roi.std) );  
        disp(sprintf('%20s\t %10.3f\t %10.3f\t %10.3f', 'min = ', roi.min) );  
        disp(sprintf('%20s\t %10.3f\t %10.3f\t %10.3f', 'max = ', roi.max) );   
        disp(sprintf('%20s\t %10.3f\t %10.3f\t %10.3f', 'median = ', roi.median) );
        disp(' ');
